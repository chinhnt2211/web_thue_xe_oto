        ...
        >
            <div class="rounded-t mb-0 px-4 py-3 border-0">
                <div class="flex flex-wrap items-center">
                    ...
                    <button
                        ...
                        type="button"
                        v-on:click="
                            this.$router.push({ name: 'Admin.Staffs.Create' })
                        "
                    >
                        Create
                    </button>
            ...
            <div class="block w-full overflow-x-auto">
                ...
                >
                    ...
                    <tbody v-if="!loading">
                        <tr
                            v-for="staff in staffsStore.staffs"
                            @click="
                                this.$router.push({
                    ...
                    >
                        <li>
                            <a
                                ...
                                :class="
                                    staffsStore.prevPage
                                        ? 'hover:bg-emerald-100 hover:text-emerald-700'
                                        : ''
                                "
                                @click="staffsStore.toPrevPage"
                            >
                        ...
                        <li v-for="link in staffsStore.links">
                            <a
                                ...
                                :class="
                                    link.label == staffsStore.currentPage
                        ...
                        <li>
                            <a
                                ...
                                :class="
                                    staffsStore.nextPage
                                        ? 'hover:bg-emerald-100 hover:text-emerald-700'
                                        : ''
                                "
                                @click="staffsStore.toNextPage"
                            >
