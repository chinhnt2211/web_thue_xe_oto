  ...
  <main class="mt-0 transition-all duration-200 ease-soft-in-out">
    <section class="min-h-screen mb-32">
      <div
        ...
        style="background-image: url('/wallpaper_signup.jpg')">
            ...
            <div
              ...
              <div class="flex-auto p-6">
                <form role="form text-left">
                  ...
                  <!-- Notice Error -->
                  <div class="rounded-xl border-red-300 border-2 p-2" v-if="isError">
                    <div class="border-dashed rounded-lg border-red-300 border-2 bg-orange-50 p-3">
                      <span class="text-size-sm text-[#fa4343] italic" v-for="error in errors">
                        <span v-for="each in error"> - {{ each }} <br></span>
                      </span>
                    </div>
                  </div>
      ...
      return {
        name: {
          firstName: {
            ...
            regexFirstName: helpers.withMessage('Giá trị không hợp lệ', regexFirstName),
          },
          lastName: {
            required: helpers.withMessage('Không được để trống ô này', required),
            regexLastName: helpers.withMessage('Giá trị không hợp lệ', regexLastName),
          },
        },
        email: {
          required: helpers.withMessage('Không được để trống ô này', required),
        ...
        password: {
          ...
          confirm: {
            required: helpers.withMessage('Không được để trống ô này', required),
            sameAS: helpers.withMessage('Mật khảu xác nhận phải khớp vơi mật khảu đã nhập', sameAs(state.password.password)),
          },
        }
      }
    });
